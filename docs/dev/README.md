...
| [foss/](foss/) | The planned FOSS attribution export: the obligations it has to satisfy, the analysis of whether this architecture can, and milestones F1-F8. Nothing in it is implemented yet. |
