...
For a complete description of the normative behavior, see [docs/sbomb-spec-v3.1.md](docs/sbomb-spec-v3.1.md).

## License

sbomb is distributed under the MIT license; see [LICENSE](LICENSE).

Its third-party dependencies and the reason each one is present are listed in
[docs/dependencies.md](docs/dependencies.md). The SPDX license texts that
`internal/license` matches against are digests of the official SPDX list, not
copies of the texts, and are regenerated by `tools/spdxgen`.
