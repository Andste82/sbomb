...
# named explicitly with -DSBOMB_FETCH_VERSION=v0.11.0.

set(SBOMB_FETCH_VERSION "@SBOMB_VERSION@"
    CACHE STRING "sbomb release to fetch, e.g. v0.11.0")
...
function(sbomb_fetch_binary)
  ...
  if(SBOMB_FETCH_VERSION MATCHES "^@.*@$")
    message(FATAL_ERROR
      ...
      "-DSBOMB_FETCH_VERSION=v0.11.0 or -DSBOMB_EXECUTABLE=<path>.")
  endif()
